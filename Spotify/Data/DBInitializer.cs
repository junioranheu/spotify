...
namespace Spotify.API.Data
{
    public static class DbInitializer
    {
        ...
        private static async Task Seed(Context context, DateTime dataAgora)
        {
            ...
            {
                await context.Playlists.AddAsync(new Playlist() { PlaylistId = 1, Nome = "Indie Rock Club", Sobre = "Apenas músicas indies", Foto = "1AAAAA.webp", CorDominante = "rgba(207, 26, 46, 1)", UsuarioId = 1, IsAtivo = true, DataRegistro = dataAgora });
                await context.Playlists.AddAsync(new Playlist() { PlaylistId = 2, Nome = "Energy Booster Rock 🤘", Sobre = "Os mais clássicos", Foto = "2AAAAA.webp", CorDominante = "rgba(236, 30, 52, 1)", UsuarioId = 1, IsAtivo = true, DataRegistro = dataAgora });
                await context.Playlists.AddAsync(new Playlist() { PlaylistId = 3, Nome = "Oi né?", Sobre = "Os hits mais tops do momento, Faraon Love Shady, por exemplo! 👌", Foto = "3AAAAA.webp", CorDominante = "rgba(45, 216, 145, 1)", UsuarioId = 1, IsAtivo = false, DataRegistro = dataAgora });
                await context.Playlists.AddAsync(new Playlist() { PlaylistId = 4, Nome = "Happy Pop Hits 💋", Sobre = "Cabro reklo", Foto = "4AAAAA.webp", CorDominante = "rgba(81, 155, 246, 1)", UsuarioId = 1, IsAtivo = true, DataRegistro = dataAgora });
                await context.Playlists.AddAsync(new Playlist() { PlaylistId = 5, Nome = "Mother Funk", Sobre = "As mais tocadas", Foto = "5AAAAA.webp", CorDominante = "rgba(34, 54, 104, 1)", UsuarioId = 1, IsAtivo = true, DataRegistro = dataAgora });
                await context.Playlists.AddAsync(new Playlist() { PlaylistId = 6, Nome = "Amor, I love you ❤️", Sobre = "Para chorar de amor", Foto = "6AAAAA.webp", CorDominante = "rgba(233, 32, 52, 1)", UsuarioId = 1, IsAtivo = true, DataRegistro = dataAgora });
            }
